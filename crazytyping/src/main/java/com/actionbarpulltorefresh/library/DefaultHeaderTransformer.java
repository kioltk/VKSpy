...
public class DefaultHeaderTransformer extends HeaderTransformer {
    ...
    private CharSequence mPullRefreshLabel, mRefreshingLabel, mRefreshingFailedLabel, mReleaseLabel;
    ...
    public void onViewCreated(Activity activity, View headerView) {
        ...
        mRefreshingFailedLabel = activity.getString(R.string.pull_to_refresh_refreshing_failed_label);
    ...
    public void onRefreshFailed(){
        ...
        if (mHeaderTextView != null) {
            mHeaderTextView.setText(mRefreshingFailedLabel);
        }
        if (mHeaderProgressBar != null) {
    ...
    private void applyProgressBarSettings() {
        if (mHeaderProgressBar != null) {
            ...
            //mHeaderProgressBar.setSmoothProgressDrawableColor();
        }
    }
