...
public class DateItem extends Item {
    ...
    public View getView(Context context) {
        ...
        TextView timeView = ((TextView) rootView.findViewById(R.id.typing));
    ...
    public View getCenterView(Context context){
        ...
        ((TextView)rootView.findViewById(R.id.typing)).setText( getDate());
        return rootView;
    }
    ...
    public void recreate(Integer unix) {
        ...
        if(rootView!=null){
            ...
            final TextView timeView = ((TextView) rootView.findViewById(R.id.typing));
