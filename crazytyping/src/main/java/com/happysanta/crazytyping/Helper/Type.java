package com.happysanta.crazytyping.Helper;
...
public class Type {
    ...
    public static void newChatTyping(final CrazyTypingService.Update update) {
    ...
    public static void newTyping(final CrazyTypingService.Update typing) {
    ...
    public static void denyTyping(final CrazyTypingService.Update update) {
    ...
    public static void showTyping(final CrazyTypingService.Update update) {
        ...
        Notificator.announce(new ArrayList<CrazyTypingService.Update>() {{
            add(update);
        }});
    }

    public static void newChatMessage(CrazyTypingService.Update update) {
        denyChatTyping(update.getUserId(), (Integer) update.getExtra());
    }

    public static void newMessage(CrazyTypingService.Update message) {
        denyTyping(message);
    }
    ...
    static class ChatTimer extends HashMap<Integer, TypingTimer> {
        ...
        public void start(CrazyTypingService.Update update) {
        ...
        public void again(CrazyTypingService.Update update) {
    ...
    static class TypingTimer extends Thread {
        public CrazyTypingService.Update update;
        private boolean again = false;
        private boolean denied = false;
        private Runnable denyCallback;
        private boolean finished = false;

        public TypingTimer(CrazyTypingService.Update update) {
            this.update = update;
        }
