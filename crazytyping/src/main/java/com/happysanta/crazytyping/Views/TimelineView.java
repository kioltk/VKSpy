package com.happysanta.crazytyping.Views;
...
public class TimelineView extends RelativeLayout {
    ...
    public static final int TIMELINE_SIMPLE = 0;
    ...
    public static final int TIMELINE_START_LONG = 5;
    ...
    public void alignCircleToTop() {
        LayoutParams circleParams = (LayoutParams) circle.getLayoutParams();

        circleParams.addRule(ALIGN_PARENT_TOP);
        circleParams.setMargins(0, (int) (dp54/2-circleParams.height/2), 0, 0);
