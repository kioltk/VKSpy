...
import com.happysanta.vkspy.Adapters.ItemHelper;
...
public class FilterActivity extends ActionBarActivity {
    ...
    public static class FilterFriendsFragment extends UsersListFragment {
        ...
        protected ListView getListView(){
            if(rootView!=null){
                return (ListView) rootView.findViewById(com.happysanta.vkspy.R.id.list);
            }
            return null;
        }
        @Override
        protected void create() {
            ...
            if (!users.isEmpty()) {
                ...
                rootView.findViewById(com.happysanta.vkspy.R.id.loading).setVisibility(View.GONE);
            } else {
                showNoUsers();
            }
        }
        ...
        public int getListEmpty() {
            return com.happysanta.vkspy.R.string.no_friends;
        }
