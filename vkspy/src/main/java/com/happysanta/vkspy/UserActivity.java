...
import com.happysanta.vkspy.Fragments.ListFragment;
...
public class UserActivity extends ActionBarActivity {
    ...
    public static abstract class UpdatesListFragment extends ListFragment{
        ...
        public View getListViewHeaderView() {
            ...
            if(activity!=null)
                return activity.getLayoutInflater().inflate(R.layout.faux_carousel_width_indicator,null);
            return null;
        }
        ...
        protected void onContentBinded() {
            ...
            if(items!=null && !items.isEmpty()){
                ...
                if(last.getTill()==Helper.ONLINE) {
                    activity.setOnline(ONLINE_TRUE);
                }else{
                    if(user.last_seen<last.getTill()){
                        user.last_seen = last.getTill();
                    }
                        activity.setOnline(user.last_seen);
